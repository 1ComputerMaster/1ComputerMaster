...
public class MemberController {
	...
	public ResponseEntity<Map<String, Object>> login(
		...
		try {
			...
			if (loginUser != null) {
				String token = jwtService.create("memberId", loginUser.getMemberId(), "access-token");// key, data, subject
...
//				로그인 사용자 정보.
	...
	@ApiOperation(value = "회원등록", notes = "회원 정보를 등록한다.", response = Map.class)
	@PostMapping("/register")
	public ResponseEntity<String> register(
			@RequestBody @ApiParam(value = "회원 등록시 필요한 회원 정보", required = true) MemberDto memberDto) throws Exception {
	...
	public ResponseEntity<String> modify(
			@RequestBody @ApiParam(value = "회원 정보 수정시 필요한 회원 정보", required = true) MemberDto memberDto) throws Exception {
